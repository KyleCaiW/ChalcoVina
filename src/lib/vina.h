...
public:
	...
	/*****************************************************************************************/
	void set_interchb_weights(double w_O, double w_S, double w_N);
	void set_intrachb_weights(double w_O, double w_S, double w_N);
	/*****************************************************************************************/
...
/*****************************************************************************************/
protected:
	double m_weight_interchb_O = 0.0;
	double m_weight_interchb_S = 0.0;
	double m_weight_interchb_N = 0.0;
	double m_weight_intrachb_O = 0.0;
	double m_weight_intrachb_S = 0.0;
	double m_weight_intrachb_N = 0.0;
/*****************************************************************************************/
};
