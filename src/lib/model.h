...
struct ligand : public flexible_body, atom_range {
	...
	/*****************************************************************************************/
	std::vector<intra_chb_pair> intra_chb_pairs;
	/*****************************************************************************************/
	context cont;
...
public:
	...
	/*****************************************************************************************/
	model() : m_num_movable_atoms(0), m_atom_typing_used(atom_type::XS), m_weight_interchb_O(0.0), m_weight_interchb_S(0.0), m_weight_interchb_N(0.0), m_chalcogen_acceptors_cached(false), m_chalcogen_donor_indices_cached(false), m_weight_intrachb_O(0.0), m_weight_intrachb_S(0.0), m_weight_intrachb_N(0.0) {}
	model(atom_type::t atype) : m_num_movable_atoms(0), m_atom_typing_used(atype), m_weight_interchb_O(0.0), m_weight_interchb_S(0.0), m_weight_interchb_N(0.0), m_chalcogen_acceptors_cached(false), m_chalcogen_donor_indices_cached(false), m_weight_intrachb_O(0.0), m_weight_intrachb_S(0.0), m_weight_intrachb_N(0.0) {}
	void set_interchb_weights(fl w_O, fl w_S, fl w_N) { m_weight_interchb_O = w_O; m_weight_interchb_S = w_S; m_weight_interchb_N = w_N; }
	void set_intrachb_weights(fl w_O, fl w_S, fl w_N) { m_weight_intrachb_O = w_O; m_weight_intrachb_S = w_S; m_weight_intrachb_N = w_N; }
    atomv get_grid_atoms() const { return grid_atoms; } // for chalcogen bond energy
	/*****************************************************************************************/
...
private:
	...
	/*****************************************************************************************/
	void initialize_intra_chb_pairs(const distance_type_matrix& mobility);
	fl eval_intra_chb_energy(const vec& v) const;
	fl eval_intra_chb_deriv(const vec& v, vecv& forces) const;
	/*****************************************************************************************/
	...
	/*****************************************************************************************/
	fl m_weight_interchb_O;
	fl m_weight_interchb_S;
	fl m_weight_interchb_N;
	fl m_weight_intrachb_O;
	fl m_weight_intrachb_S;
	fl m_weight_intrachb_N;
	mutable std::vector<chalcogen_acceptor> m_cached_chalcogen_acceptors;
	mutable bool m_chalcogen_acceptors_cached;
	mutable std::vector<chalcogen_donor_indices> m_cached_chalcogen_donor_indices;
	mutable bool m_chalcogen_donor_indices_cached;
	/*****************************************************************************************/
};
